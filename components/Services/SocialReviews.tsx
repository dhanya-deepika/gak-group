  ...
  return (
    <section className="bg-white py-12 sm:py-20 flex flex-col items-center px-4 sm:px-8">
      ...
      <div className="relative flex items-center justify-center w-full max-w-[950px]">
        ...
        {/* Review Content */}
        <div className="flex flex-col sm:flex-row w-full max-w-[850px] sm:max-w-[950px] min-h-[200px] sm:min-h-[256px] mx-auto">
          {/* Logo side */}
          <div className="flex items-center justify-center w-[120px] h-[120px] sm:w-[200px] sm:h-[200px] bg-gradient-to-br from-gray-50 to-gray-100 rounded-2xl sm:rounded-3xl shadow-md mx-auto sm:mx-0">
            <Image

...
export default function FooterSection() {
  const [formData, setFormData] = useState({
    name: "",
    email: "",
    phone: "", // ✅ renamed from number → phone
    message: "",
  });
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    setFormData({ name: "", email: "", phone: "", message: "" }); // ✅ reset phone correctly
  };
...
<div className="flex flex-col md:flex-row items-center justify-between gap-6 md:gap-12 w-full">
  ...
  <div className="flex flex-col items-center md:flex-row md:items-center gap-6 md:gap-12 w-full md:w-auto">
    ...
    {/* Social Media */}
    <div className="flex flex-row gap-6 mt-4 md:mt-0 text-black text-xl justify-center md:justify-start">
  ...
  {/* Links */}
  <div className="flex flex-row gap-8 mt-4 md:mt-0 text-black font-sans text-base sm:text-lg justify-center md:justify-end">

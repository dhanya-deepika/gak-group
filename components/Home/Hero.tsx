...
//   const slides = [
//     "/homepagebanners/1.jpg",
//     "/homepagebanners/2.jpg",
//     "/homepagebanners/3.jpg",
//     "/homepagebanners/4.jpg",
//     "/homepagebanners/5.jpg",
//   ];
...
//   >
//     {slides.map((img, i) => (
//       <div key={i} className="h-screen w-full flex-shrink-0 relative">
//         {/* Image */}
//         <img
//           src={img}
//           alt={`Slide ${i + 1}`}
...
export default function HeroSection() {
  ...
  return (
   ...
   <section id="hero" className="relative h-[60vh] sm:h-[80vh] md:h-screen w-full overflow-hidden">
  {/* Slides */}
  <div
    className="flex h-full w-full transition-transform duration-700 ease-in-out"
    style={{ transform: `translateX(-${current * 100}%)` }}

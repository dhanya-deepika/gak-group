...
export default function WhyChooseUs() {
  ...
  // 5 slides data from client
  const slides = [
    { type: "image", src: "/whychoose/w1.jpg" },
    { type: "image", src: "/whychoose/w2.jpg" },
    { type: "image", src: "/whychoose/w3.jpg" },
    { type: "image", src: "/whychoose/w4.jpg" },
    { type: "image", src: "/whychoose/w5.jpg" },
  ];
  ...
  return (
    <section className="relative w-full bg-white py-12 md:py-20 flex justify-center">
      <div className="max-w-[1316px] w-full flex flex-col md:flex-row items-center justify-center gap-6 md:gap-8 px-4">
        ...
        <div className="relative w-[90%] sm:w-[420px] md:w-[530px] h-[280px] sm:h-[380px] md:h-[485px] flex items-center justify-center mx-auto">
          {slides.map((slide, i) => {
            // calculate relative index (-2, -1, 0, 1, 2)
            const index = (i - current + slides.length) % slides.length;
          ...
          <button
            onClick={prevSlide}
            className="absolute -left-6 sm:-left-10 md:-left-14 lg:-left-60 top-1/2 -translate-y-1/2 text-black text-lg sm:text-xl z-50"
          >
            ◀
          </button>
          ...
          <button
            onClick={nextSlide}
            className="absolute right-[-30px] sm:right-[-40px] md:right-[-50px] lg:right-[-250px] top-1/2 -translate-y-1/2 text-black text-lg sm:text-xl z-50"
          >
            ▶
          </button>

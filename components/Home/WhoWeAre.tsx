...
export default function WhoWeAre() {
  return (
    <section
      id="who-we-are"
      className="relative min-h-screen flex flex-col justify-center py-4 sm:py-16 px-4 sm:px-8 overflow-hidden"
    >
        ...
        <div className="mb-4 sm:mb-12 text-center md:text-left">
          <h2
            className="
              ...
              font-bold text-gray-900 mb-2 sm:mb-4 font-[Sora] 
              md:pl-30
            "
          >
            WHO WE ARE
          ...
          >
            ...
            in strategic real estate investments. We provide residential and
            commercial real estate advisory services, property investment
            advisory, and real estate risk assessment, helping clients secure
            high-potential properties with confidence and long-term value.
          </p>
        </div>
